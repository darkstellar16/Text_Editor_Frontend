...
const ReszieComp = ({ componentId }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`https://text-editor-backend-3.onrender.com/v1/adds?componentId=${componentId}`)
    ...
    const handleAddButton = async () => {
        try {
            await axios.post('https://text-editor-backend-3.onrender.com/v1/add',
                {
    ...
    const handleupdateButton = async () => {
        try {
            ...
            await axios.post('https://text-editor-backend-3.onrender.com/v1/update',
                {
                    componentId: componentId,
                    content: Text
                });
